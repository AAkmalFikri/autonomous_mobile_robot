...
static const double DISTANCE_RESOLUTION = 0.004; /**< meters */
...
static const double  BLOCK_TDURATION   = 30; // [µs]
static const double  DSR_TOFFSET       = 1;   // [µs]
static const double  FIRING_TOFFSET    = 15;  // [µs]
